...
import { runPhase, runPhasePartTwo } from "./phase";
...
describe("runPhasePartTwo", () => {
  test("Example 1", () => {
    const intcodes = parse(
      `3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5`,
    );
    const inputs = [9, 8, 7, 6, 5];
    const output = 139629729;

    expect(runPhasePartTwo(intcodes, inputs)).toBe(output);
  });
